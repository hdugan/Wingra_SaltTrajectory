...
mendotaWS = st_read('data_GIS/YaharaBasins/Mendota_Basin.shp')
mononaWS = st_read('data_GIS/YaharaBasins/Monona_Basin.shp')
subbasinsWS = st_read('data_GIS/YaharaBasins/Yahara_subBasins.shp')
